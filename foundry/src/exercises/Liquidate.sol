...
contract Liquidate {
        ...
        public
    {
        ...
        IPool.ReserveData memory data = pool.getReserveData(borrowedToken);
        uint256 debt = IERC20(data.variableDebtTokenAddress).balanceOf(user);
        ...
        pool.liquidationCall(collateral, borrowedToken, user, debt, false);
    }
}
